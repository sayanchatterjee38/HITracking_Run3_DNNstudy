...
# with command line options: step5 -s PAT --conditions auto:phase1_2022_realistic_hi -n 2 --datatier MINIAODSIM --eventcontent MINIAODSIM --era Run3_pp_on_PbPb --procModifiers genJetSubEvent
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Run3_pp_on_PbPb_cff import Run3_pp_on_PbPb
from Configuration.ProcessModifiers.genJetSubEvent_cff import genJetSubEvent

process = cms.Process('PAT',Run3_pp_on_PbPb,genJetSubEvent)
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:mb_AOD.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PbPb_MINIAODSIM_mb_PAT.root'),
