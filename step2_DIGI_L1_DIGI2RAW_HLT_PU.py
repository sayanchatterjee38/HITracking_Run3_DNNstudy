...
# with command line options: step2 -s DIGI:pdigi_hi_nogen,L1,DIGI2RAW,HLT:@fake2 --conditions auto:phase1_2022_realistic_hi --datatier GEN-SIM-DIGI-RAW-HLTDEBUG --eventcontent FEVTDEBUGHLT --era Run3_pp_on_PbPb -n 2 --pileup HiMixNoPU
